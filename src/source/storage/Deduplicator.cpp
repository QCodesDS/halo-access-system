...
bool recordsEqual(const LogRecord& r1, const LogRecord& r2) {
    return r1.timestamp == r2.timestamp && r1.event_type == r2.event_type && r1.location == r2.location &&
           strEquals(r1.user_id, r2.user_id) && strEquals(r1.device_id, r2.device_id) &&
           strEquals(r1.app_id, r2.app_id) && strEquals(r1.resource_id, r2.resource_id);
}
